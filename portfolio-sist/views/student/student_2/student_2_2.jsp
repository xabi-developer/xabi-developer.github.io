						...
						<nav class="navbar navbar-expand bg-light navbar-light"
							...
							<ul class="navbar-nav">
								...
								<li class="nav-item active"><a class="nav-link"
									href="${pageContext.request.contextPath}/portfolio-sist//views/student/student_2/student_2_2.jsp"
									...
									<div class="table-responsive">
                                       ...
                                       <tr><th class='bg-light'>ISBN</th><td>123456</td></tr>
													...
													<td><a href="#" data-toggle="popover"
														...
														data-content="<img src='${pageContext.request.contextPath}/portfolio-sist/resources/images/book/avatars/0.jpg'>"
												...
												<tr>
													...
													<td><a href="#" data-toggle="popover"
														...
														data-html="true" title="즐거운 Java"
														data-content="<div class='panel page-header' style='text-align: center;'>
                                       <img src='${pageContext.request.contextPath}/portfolio-sist/resources/images/book/image1.png'>
                                       <table class='table' style='text-align: center; font-size: 12px'>
                                       <tr><th class='bg-light'>교재 아이디</th><td>B01</td></tr>
                                       ...
                                       <tr><th class='bg-light'>ISBN</th><td>123456</td></tr>
													...
													<td><a href="#" data-toggle="popover"
														data-placement="right" data-trigger="hover"
														data-html="true" title=""
														data-content="<img src='${pageContext.request.contextPath}/portfolio-sist/resources/images/avatars/3.jpg'>"
														data-original-title="김선생">김선생</a></td>
													<td>20</td>
													<td>50</td>
													<td>30</td>
