						...
						<nav class="navbar navbar-expand bg-light navbar-light"
							...
							<ul class="navbar-nav">
								...
								<li class="nav-item active"><a class="nav-link"
									href="${pageContext.request.contextPath}/portfolio-sist/views/admin/admin_3/admin_3_2.jsp"
										...
										<tbody>
											<tr>
												...
												<td><a href="#" data-toggle="popover"
													...
													data-content="<img src='${pageContext.request.contextPath}/portfolio-sist/resources/images/avatars/0.jpg'>"
