								...
								<div class="table-responsive">
									<table class="table"
										...
										<tbody>
											<tr>
												<td>OPC01</td>
												<td>클라우드 컴퓨팅 기반의 <br> 빅데이터 저문가(Java개발)
												</td>
												<td>2017-01-05</td>
												<td>2017-07-20</td>
												<td>1반</td>
												...
												<td><button type="button"
														...
														onclick="location.href='${pageContext.request.contextPath}/portfolio-sist/views/admin/admin_5/admin_5_2.jsp'
														">
									...
									<div class="col-md-12">
										<form class="form-inline" method="post">
											...
											<select class="form-control" id="key" name="key"
												...
												<option value="tid">개설과정아이디</option>
