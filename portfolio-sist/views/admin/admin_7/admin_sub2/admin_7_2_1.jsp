												...
												<tbody>
													<tr>
														...
														<td><button type="button"
																...
																onclick="location.href='${pageContext.request.contextPath}/portfolio-sist/views/admin/admin_7/admin_sub2/admin_7_2_2.jsp'">
													...
													<tr>
														...
														<td><a href="#" data-toggle="popover"
															data-placement="right" data-trigger="hover"
															data-html="true" title="이사비"
															data-content="<img src='${pageContext.request.contextPath}/portfolio-sist/resources/images/avatars/1.jpg'>">이사비</a></td>
														<td>010-3333-4444</td>
														<td>2017-05-21</td>
														<td>1</td>
														<td><button type="button"
										...
										<div class="col-md-12">
											<form class="form-inline" method="post">
												...
												<select class="form-control" id="key" name="key"
													...
													<option value="course_id">수강생아이디</option>
													<option value="course_name" style="">수강생명</option>
												</select>
												<!-- 검색 단어 입력 폼 -->
