							...
							<ul class="navbar-nav">
								...
								<li class="nav-item"><a class="nav-link"
									style="font-size: 12px; text-align: center;"><i
										class="fas fa-angle-right"></i></a></li>
								<li class="nav-item"><a class="nav-link active"
									href="${pageContext.request.contextPath}/portfolio-sist/views/admin/admin_2/admin_sub3/admin_2_3_1.jsp"
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form
						action="${pageContext.request.contextPath}/portfolio-sist/views/admin/admin_2/admin_sub3/admin_2_3_1.jsp"
						method="POST">
