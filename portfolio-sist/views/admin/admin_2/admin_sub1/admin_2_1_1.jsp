...
<body class="h-100">
					...
					<form action="#"
						...
						<nav class="navbar navbar-expand bg-light navbar-light"
							...
							<ul class="navbar-nav">
								...
								<li class="nav-item"><a class="nav-link active"
									href="${pageContext.request.contextPath}/portfolio-sist/views/admin/admin_2/admin_sub1/admin_2_1_1.jsp"
									style="font-size: 12px; text-align: center;">과정관리</a></li>
			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						...
						<h3 class="page-title">과정관리</h3>
						<span style="font-size: 13px">과정을 조회, 추가, 삭제할 수 있습니다.</span> <br>
						<br>
						<!-- 세부 메뉴 네비게이션 바 -->
								...
								<div class="">
									...
									<div class="panel page-header" style="text-align: right;">
										<button type="button" class="btn btn-default btn-xs btnAdd"
											data-toggle="modal" data-target="#addModal">과정추가</button>
										<p>
										<div class="card-body p-0 pb-3 text-center">
											<table class="table mb-0"
												...
												<tbody>
													...
													<tr>
														<td>CSS03</td>
														<td>Java & Python 응용SW실무개발자 양성 과정</td>
														<td><div class="btn-group">
															<button type="button"
																class="btn btn-default btn-xs btnModify"
																data-toggle="modal" data-target="#modifyModal">수정</button>
											...
											<div class="col-md-12">
												...
												<form class="form-inline" method="post">
													<button type="button" class="btn btn-default btn-md"
														style="height: 40px;">
														총 <span class="badge" id="totalcount">5</span>건
													</button>
		...
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<h6>현재 선택한 과정 정보를 수정할까요?</h6>
					<div style="margin-bottom: 10px">
						<span style="font-size: 13px; font-weight: bold;">과정아이디</span>
						<div class="input-group">
							<input type="text" class="form-control" id="modify_opencourse_id"
								name="modify_opencourse_id" value="" placeholder="SUB01"
								readonly="readonly">
					...
					<div style="margin-bottom: 10px">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="modify_opencourse_name"
								name="modify_opencourse_name" value="" placeholder="클라우드 컴퓨팅 기반의 빅데이터전문가(Java개발)">
							<div class="input-group-prepend"></div>
						</div>
					</div>
				</div>
				...
				<div class="modal-body">
					...
					<form
						...
						<div style="margin-bottom: 10px">
							<span style="font-size: 13px; font-weight: bold;">과정아이디</span>
							<div class="input-group">
								<input type="text" id="delete_opencourse_id" name="delete_opencourse_id"
						...
						<div style="margin-bottom: 10px">
							<span style="font-size: 13px; font-weight: bold;">과정명</span>
							<div class="input-group">
								<input type="text" id="delete_opencourse_name" name="delete_opencourse_name"
									class="form-control" value="" readonly="readonly"
									placeholder="클라우드 컴퓨팅 기반의 빅데이터전문가(Java개발)">
							</div>
						</div>
	...
	<div id="addModal" class="modal fade" role="dialog">
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">과정 추가</h4>
					<button type="button" class="close" data-dismiss="modal">&times;</button>
				</div>
				<div class="modal-body">
					<h6>현재 선택한 과정 정보를 추가합니다.</h6>
					<form
						action="${pageContext.request.contextPath}/portfolio-sist/views/admin/admin_2/admin_sub1/admin_2_1_1.jsp"
						method="POST">
						...
						<div style="margin-bottom: 10px">
							<span style="font-size: 13px; font-weight: bold;">과정명</span>
							<div class="input-group">
								<input type="text" id="add_opencourse_name" name="add_opencourse_name"
									class="form-control" value="" placeholder="opencourse_name">
							</div>
						</div>
