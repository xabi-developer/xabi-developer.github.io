							...
							<ul class="navbar-nav">
								...
								<li class="nav-item"><a class="nav-link"
									style="font-size: 12px; text-align: center;"><i
										class="fas fa-angle-right"></i></a></li>
								<li class="nav-item"><a class="nav-link active"
									href="${pageContext.request.contextPath}/portfolio-sist/views/admin/admin_2/admin_sub2/admin_2_2_1.jsp"
									style="font-size: 12px; text-align: center;">과목관리</a></li>
			...
			<div class="main-content-container container-fluid px-4">
				...
				<div class="page-header row no-gutters py-4">
					<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
						...
						<h3 class="page-title">과목관리</h3>
						<span style="font-size: 13px">과목을 조회, 추가, 삭제할 수 있습니다.</span> <br>
						<br>
						<!-- 세부 메뉴 네비게이션 바 -->
							...
							<div class="card-body">
								...
								<div class="panel page-header" style="text-align: right;">
									<button type="button" class="btn btn-default btn-xs btnAdd"
										data-toggle="modal" data-target="#addModal">과목추가</button>
									<p>
	...
	<div id="deleteModal" class="modal fade" role="dialog">
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<h6>현재 선택한 과목 정보를 삭제할까요?</h6>
					<form
						action="${pageContext.request.contextPath}/portfolio-sist/views/admin/admin_2/admin_sub2/admin_2_2_1.jsp"
						method="POST">
						<div style="margin-bottom: 10px">
							<span style="font-size: 13px; font-weight: bold;">과목아이디</span>
							<div class="input-group">
								<input type="text" id="delete_subject_id" name="delete_subject_id"
						...
						<div style="margin-bottom: 10px">
							<span style="font-size: 13px; font-weight: bold;">과목명</span>
							<div class="input-group">
								<input type="text" id="delete_subject_name" name="delete_subject_name"
									class="form-control" value="" readonly="readonly"
									placeholder="JAVA">
							</div>
						</div>
	...
	<div id="addModal" class="modal fade" role="dialog">
		<div class="modal-dialog modal-md">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<h6>현재 선택한 과목 정보를 추가합니다.</h6>
					<form
						action="${pageContext.request.contextPath}/portfolio-sist/views/admin/admin_2/admin_sub1/admin_2_2_1.jsp"
						method="POST">

						<div style="margin-bottom: 10px">
							<span style="font-size: 13px; font-weight: bold;">과목명</span>
							<div class="input-group">
								<input type="text" id="add_subject_name" name="add_subject_name"
									class="form-control" value="" placeholder="subject_name">
							</div>
						</div>
