						...
						<nav class="navbar navbar-expand bg-light navbar-light"
							...
							<ul class="navbar-nav">
								...
								<li class="nav-item active"><a class="nav-link"
									href="${pageContext.request.contextPath}/portfolio-sist/views/teacher/teacher_3/teacher_3_2.jsp"
										...
										<table class="table"
											...
											<tbody>
												<tr>
													...
													<td>2017-03-05</td>
													<td><a href>OPC01_OPS01_1.zip</a></td>
			...
			<div class="modal-dialog modal-sm">
				...
				<div class="modal-content">
					<div class="modal-header">
						<h6 class="modal-title">( OPS01 / Java ) 과목 배점 및 시험날짜 등록</h6>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
					<div class="modal-body">
						<div style="text-align: center;">
							<form
								action="${pageContext.request.contextPath}/portfolio-sist/employee/fileUpload"
								method="POST" enctype="multipart/form-data" class="form-inline">
								출결 배점 : <input type="text" id="pw" name="pw"><br>
								필기 배점 : <input type="text" id="newpw" name="newpw"><br>
								실기 배점 : <input type="text" id="newpw2" name="newpw2"><br>
								시험 날짜 : <input type="date" id="newpw2" name="newpw2"><br>
								<br>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="margin-bottom: 10px">
						<span style="font-size: 13px; font-weight: bold;">개설 과목 아이디</span>
						<div class="input-group">
							<input type="text" class="form-control" id="add_opensubject_id"
								name="add_opensubject_id" value="" placeholder="OPS04"
								readonly="readonly">
					...
					<div style="margin-bottom: 10px">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="add_subject_name"
								name="add_subject_name" value="" placeholder="Java"
								readonly="readonly">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					<div style="margin-bottom: 10px">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="add_attendance_points"
								name="add_attendance_points" value="" placeholder="Max 20">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					...
					<div style="margin-bottom: 10px">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="add_written_points"
								name="add_written_points" value="" placeholder="">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					<div style="margin-bottom: 10px">
						...
						<div class="input-group">
							<input type="text" class="form-control" id="add_practice_points"
								name="add_practice_points" value="" placeholder="">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					<div style="margin-bottom: 10px">
						...
						<div class="input-group">
							<input type="date" class="form-control" id="add_exam_date"
								name="add_exam_date" value="" placeholder="name">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					<div style="margin-bottom: 10px">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div style="margin-bottom: 10px">
						<span style="font-size: 13px; font-weight: bold;">개설 과목 아이디</span>
						<div class="input-group">
							<input type="text" class="form-control" id="modify_opensubject_id"
								name="modify_opensubject_id" value="" placeholder="OPS04"
								readonly="readonly">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					<div style="margin-bottom: 10px">
						<span style="font-size: 13px; font-weight: bold;">과목명</span>
						<div class="input-group">
							<input type="text" class="form-control" id="modify_subject_name"
								name="modify_subject_name" value="" placeholder="Java"
								readonly="readonly">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					<div style="margin-bottom: 10px">
						<span style="font-size: 13px; font-weight: bold;">출결 배점</span>
						<div class="input-group">
							<input type="text" class="form-control" id="modify_attendance_points"
								name="modify_attendance_points" value="" placeholder="0">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					...
					<div style="margin-bottom: 10px">
						<span style="font-size: 13px; font-weight: bold;">필기 배점</span>
						<div class="input-group">
							<input type="text" class="form-control" id="modify_written_points"
								name="modify_written_points" value="" placeholder="0">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					<div style="margin-bottom: 10px">
						<span style="font-size: 13px; font-weight: bold;">실기 배점</span>
						<div class="input-group">
							<input type="text" class="form-control" id="modify_parctice_points"
								name="modify_parctice_points" value="" placeholder="0">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					<div style="margin-bottom: 10px">
						<span style="font-size: 13px; font-weight: bold;">시험 날짜</span>
						<div class="input-group">
							<input type="date" class="form-control" id="modify_exam_date"
								name="modify_exam_date" value="" placeholder="2017-03-05">
							<div class="input-group-prepend"></div>
						</div>
					</div>
					...
					<form action="" method="POST">
						<div style="margin-bottom: 10px">
							<span style="font-size: 13px; font-weight: bold;">개설 과목
								아이디</span>
							<div class="input-group">
								<input type="text" id="del_opensubject_id" name="del_opensubject_id"
						...
						<div style="margin-bottom: 10px">
							<span style="font-size: 13px; font-weight: bold;">과목명</span>
							<div class="input-group">
								<input type="text" id="del_subject_name" name="del_subject_name"
									class="form-control" value="" readonly="readonly"
									placeholder="Java">
							</div>
						</div>
						<div style="margin-bottom: 10px">
							<span style="font-size: 13px; font-weight: bold;">시험 날짜</span>
							<div class="input-group">
								<input type="text" id="del_exam_date" name="del_exam_date"
									class="form-control" value="" readonly="readonly"
									placeholder="2017-03-05	">
							</div>
						</div>
						<div style="margin-bottom: 10px">
							<span style="font-size: 13px; font-weight: bold;">시험 문제</span>
							<div class="input-group">
								<input type="text" id="del_exam_file
								
								" name="del_exam_file"
									class="form-control" value="" readonly="readonly"
									placeholder="OPC01_OPS01_1.zip">
							</div>
						</div>
					</form>
				</div>
